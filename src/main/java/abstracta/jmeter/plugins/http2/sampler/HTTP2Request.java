...
public class HTTP2Request extends AbstractSampler implements TestStateListener, ThreadListener {
    ...
    public Boolean isFollowRedirects() {
        return getPropertyAsBoolean("followRedirects");
    }

    public void setAutoRedirect(Boolean autoRedirect) {
        setProperty("autoRedirect", autoRedirect);
    }

    public Boolean isAutoRedirect() {
        return getPropertyAsBoolean("autoRedirect");
    }
    
    public void setSyncRequest(Boolean syncRequest) {
        setProperty("syncRequest", syncRequest);
    }
